...
const EditProfileModal = ({ isOpen, onClose }) => {
  ...
  return createPortal(
    ...
    >
      <div
        data-lenis-prevent
        className="relative w-full max-w-md max-h-[90vh] overflow-y-auto bg-[#10131A] border border-white/[0.12] rounded-2xl shadow-[0_25px_60px_rgba(0,0,0,0.8)]"
      ...
      >
        ...
        {/* Tab Switcher */}
        <div className="flex px-6 pt-3 pb-1 border-b border-white/[0.06] gap-2 sticky top-[69px] bg-[#10131A]/95 backdrop-blur-sm z-10">
          <button
            type="button"
            onClick={() => setActiveTab('profile')}
            className={`flex items-center gap-2 pb-2.5 text-xs font-semibold transition-all relative cursor-pointer ${
              activeTab === 'profile'
                ? 'text-[#E07A38] border-b-2 border-[#E07A38]'
        ...
        <div className="p-4 sm:p-4.5 bg-white/[0.02] border-t border-white/[0.06] flex items-center justify-between gap-3">
          ...
          <button
            ...
            className="px-3.5 py-1.5 rounded-xl bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 hover:text-rose-300 border border-rose-500/20 hover:border-rose-500/40 text-xs font-semibold flex items-center gap-1.5 cursor-pointer active:scale-95 transition-all shrink-0 min-h-[34px]"
          >
